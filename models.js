 ...
 * @property {ObjectId} Genre - Reference to Genre document (required)
 * @property {ObjectId} Director - Reference to Director document (required)
 * @property {ObjectId[]} Actors - Array of Actor document references
